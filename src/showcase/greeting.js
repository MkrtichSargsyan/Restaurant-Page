export default (() => {
  ...
  greeting.innerHTML = `
    ...
    <div>
      <button route='#contact' class="uppercase px-6 py-3 mr-3 outline-none rounded-full bg-yellow-600 text-blue-50 max-w-max shadow-sm hover:bg-yellow-500 transition-all duration-500">
        CONTACT US
      </button>
